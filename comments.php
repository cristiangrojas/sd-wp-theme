...
printf( _n( '(1) Reader Comment', '(%1$s) Readers Comments ', get_comments_number(), 'skyali' ),
...
<?php else : // or, if we don't have comments:
	...
	if ( ! comments_open() ) :
?>
	<p class="nocomments"><?php _e( 'Comments are closed.', 'skyali' ); ?></p>
...
<div class="heading"><h2><?php _e('Leave A Reply', 'skyali'); ?></h2></div>
