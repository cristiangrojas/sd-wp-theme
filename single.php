...
<div class="heading"><h2><?php _e('Share This Article', 'skyali'); ?></h2></div>
...
<div class="heading"><h2><?php _e('Related News', 'skyali'); ?></h2></div><!-- #heading -->
...
<div class="heading"><h2><?php _e('About Author', 'skyali'); ?></h2></div>
...
<?php if(get_option('skypanel_broadcast_comment_section') != 'Disabled') { comments_template( '', true ); } ?>
