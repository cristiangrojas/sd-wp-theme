...
if(isset($_POST['submitform'])){
	if($name_post != '' && $email_post != '' && $message_post != '' && $_POST['num_check'] == 7 && get_option('skypanel_broadcast_contact_email') != ''){
$Name = "".$name_post.""; //senders name
$email = "".$email_post.""; //senders e-mail adress
$recipient = "".get_option('skypanel_broadcast_contact_email').""; //recipient
...
<?php the_content(); ?>
 ...
 <?php if ( get_option('skypanel_broadcast_contact_email') == '' ) { ?>
