...
<div id="header_navigation">
    ...
    <div id="top_navigation">
        ...
        <div class="header_right_side">
            ...
            <p<?php if (get_option('skypanel_broadcast_display_date') != 'Enabled') {
                echo ' class="hideobject"';
            } ?>><?php echo date('l, M. j, Y'); ?></p>

<span class="timestamp<?php if (get_option('skypanel_broadcast_display_date') != 'Enabled') {
    echo ' hideobject';
} ?>"><script type="text/javascript" language="JavaScript"><!--
        user_time();
        //--></script></span>

            <ul<?php if (get_option('skypanel_broadcast_display_rss') != 'Enabled') {
                echo ' class="hideobject"';
            } ?>>
                <li><a href="<?php echo home_url() . '?feed=rss2'; ?>"><img
                            src="<?php echo get_template_directory_uri(); ?>/images/header-rss-icon.png"
                            class="rss_icon"
                            alt="<?php _e('Follow our feed', 'skyali'); ?>"/><?php _e('Subscribe to rss', 'skayli'); ?>
                    </a></li>
            </ul>
