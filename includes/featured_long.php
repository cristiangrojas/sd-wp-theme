...
<?php  $featured_cat = get_option('skypanel_broadcast_feature_by_category'); //get featured category ?>
...
<a href="<?php echo the_permalink(); ?>" class="featured_button imgf"><?php _e('Read More', 'skyali'); ?></a>
