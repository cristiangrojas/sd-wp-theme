<?php $i = 0; ?>
<?php $category_array = get_option('skypanel_broadcast_blog_posts_-_select_categories'); ?>
...
{
	echo '<h3 style="float:left; padding:10px; font-size:13px; color:red;">No Categories selected, To setup your categories go into the options panel. Appearance >> Broadcast Options >>  Home Page >> Blog Posts >> Blog Style 1 Select categories >> Save Changes. </h3>';
} 
?>
