...
<?php $check_feature_style = get_option('skypanel_broadcast_featured_style'); ?>
...
<div class="readm"><div class="button"><a href="<?php the_permalink(); ?>" class="imgf"><?php _e('Read More','skyali'); ?></a></div><!-- button --></div><!-- #readm -->
