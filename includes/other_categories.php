...
<div class="heading"><h2><?php _e('Other Categories', 'skyali'); ?></h2></div><!-- #heading -->

<ul id="other_categories">

<?php $n = 0; ?>

<?php $other_category_array = get_option('skypanel_broadcast_select_categories'); ?>
...
<?php $other_cat_name = strtolower($other_cat_name); ?>

<?php $other_cat_name = str_replace(' ','',$other_cat_name); ?>

<li<?php if($n == 0){ echo ' class="active"'; }?>><a href="#<?php echo $other_cat_name; ?>"><?php echo get_cat_name($other_category_array[$n]); ?></a></li>
...
<?php $other_category_array_2 = get_option('skypanel_broadcast_select_categories'); ?>
...
<?php $other_cat_name_2 = strtolower($other_cat_name_2); ?>

<?php $other_cat_name_2 = str_replace(' ','',$other_cat_name_2); ?>
