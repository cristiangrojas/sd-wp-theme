...
$meta_box = array('id' => 'sticky-meta-box','title' => ''.$sticky.' Sticky Post?','page' => 'post','context' => 'side','priority' => 'high','fields' => array(array('name' => 'Sticky',
'id' => $prefix . 'sticky','type' => 'checkbox') ) );

$slider_box = array( 'id' => 'slider-meta-box', 'title' => ''.$slider.' Add To Featured Slider?', 'page' => 'post', 'context' => 'side', 'priority' => 'high', 'fields' => array(array('name' => 'Slider', 'id' => $prefix. 'slider', 'type'=> 'checkbox' ) ) );

$spotlight_box = array( 'id' => 'spotlight-meta-box', 'title' => ''.$spotlight.' Add To Spotlight?', 'page' => 'post', 'context' => 'side', 'priority' => 'high', 'fields' => array(array('name' => 'Spotlight', 'id' => $prefix. 'spotlight', 'type'=> 'checkbox' ) ) );
...
$video_box = array('id' => 'video-meta-box', 'title'=> ''.$video.' Set Featured Video', 'page' => 'post', 'context' => 'side', 'priority' => 'high', 'fields' => array(array('name' => 'Embed', 'id'=> $prefix. 'video', 'type' => 'textarea', 'std' => '') ) );
