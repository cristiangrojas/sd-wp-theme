...
class lt_tabs_widget extends WP_Widget {
	...
	function lt_tabs_widget() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'lt_tabs_widget', 'description' => __('Sidebar Tabs Widget', 'skyali') );

		/* Widget control settings. */
		//$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'lt_tabs_widget' );

		/* Create the widget. */
		$this->WP_Widget( 'lt_tabs_widget', __('LT - Sidebar Tabs', 'skyali'), $widget_ops );
	}
...
<li class="ui-tabs-selected"><a href="#populartab"><?php _e('Popular','skyali'); ?></a></li>

<li class=""><a href="#recenttab"><?php _e('Recent','skyali'); ?></a></li>

<li class=""><a href="#commentstab"><?php _e('Comments','skyali'); ?></a></li>

<li class="tagslast"><a href="#tagtab" class="tagslast"><?php _e('Tags','skyali'); ?></a></li>
