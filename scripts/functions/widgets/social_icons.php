...
class lt_social_icons extends WP_Widget {
	...
	function lt_social_icons() {
		...
		/* Create the widget. */
		$this->WP_Widget( 'lt_social_icons', __('LT - Social Icons', 'skyali'), $widget_ops);
	}
	...
	function widget( $args, $instance ) {
     ...
     <ul id="social_icons">
     <li><a href="http://www.twitter.com/<?php echo $twitter; ?>"><img src="<?php echo get_template_directory_uri();?>/images/twitter_social_icon<?php if(get_option('skypanel_broadcast_footer_style') == 'Bright') { echo '_bright';} ?>.png" width="28" height="28" class="socialimg imgf"/><span class="socialtext"><?php _e('Twitter', 'skyali'); ?></span></a></li>
     
     <li><a href="http://www.facebook.com/<?php echo $facebook; ?>"><img src="<?php echo get_template_directory_uri();?>/images/facebook_social_icon<?php if(get_option('skypanel_broadcast_footer_style') == 'Bright') { echo '_bright';} ?>.png" width="28" height="28" class="socialimg imgf"/><span class="socialtext"><?php _e('Facebook', 'skyali'); ?></span></a></li>
     
     <li><a href="<?php echo home_url() .'?feed=rss2'; ?>"><img src="<?php echo get_template_directory_uri();?>/images/rss_social_icon<?php if(get_option('skypanel_broadcast_footer_style') == 'Bright') { echo '_bright';} ?>.png" width="28" height="28" class="socialimg imgf"/><span class="socialtext"><?php _e('RSS Feed', 'skyali'); ?></span></a></li>
     
    <?php if(empty($vimeo)){ echo '<div class="hideobject">';}?> <li><a href="http://www.vimeo.com/<?php echo $vimeo; ?>"><img src="<?php echo get_template_directory_uri();?>/images/vimeo_social_icon<?php if(get_option('skypanel_broadcast_footer_style') == 'Bright') { echo '_bright';} ?>.png" width="28" height="28" class="socialimg imgf"/><span class="socialtext"><?php _e('Vimeo', 'skyali'); ?></span></a></li> <?php if(empty($vimeo)){ echo '</div>';}?> 
