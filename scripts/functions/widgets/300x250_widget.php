...
class lt_300x250_widget extends WP_Widget {
	...
	function lt_300x250_widget() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'lt_300x250_widget', 'description' => __('300 x 250 Ad/Banner Widget.', 'skyali') );

		/* Widget control settings. */
		//$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'lt_300x250_widget' );

		/* Create the widget. */
		$this->WP_Widget( 'lt_300x250_widget', __('LT - 300 X 250 Ad', 'skyali'), $widget_ops );
	}
