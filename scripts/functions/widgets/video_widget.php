...
class lt_video_widget extends WP_Widget {
	...
	function lt_video_widget() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'lt_video_widget', 'description' => __('Embed a video into the sidebar.', 'skyali') );

		/* Widget control settings. */
		//$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'lt_300x250_widget' );

		/* Create the widget. */
		$this->WP_Widget( 'lt_video_widget', __('LT - Video Embed', 'skyali'), $widget_ops);
	}
