...
class lt_sidebar_news_widget extends WP_Widget {
	...
	function lt_sidebar_news_widget() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'lt_sidebar_news_widget', 'description' => __('Display recent news.', 'skyali') );

		/* Widget control settings. */
		//$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'lt_300x250_widget' );

		/* Create the widget. */
		$this->WP_Widget( 'lt_sidebar_news_widget', __('LT - Recent News', 'skyali'), $widget_ops);
	}
