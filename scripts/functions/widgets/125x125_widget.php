...
class lt_125x125_widget extends WP_Widget {
	...
	function lt_125x125_widget() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'lt_125x125_widget', 'description' => __('125 X 125 Ad/Banner Widget.', 'skyali') );

		/* Widget control settings. */
		//$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'lt_300x250_widget' );

		/* Create the widget. */
		$this->WP_Widget( 'lt_125x125_widget', __('LT - 125 X 125 Ad', 'skyali'), $widget_ops );
	}
