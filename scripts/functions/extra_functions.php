...
function skyali_load_scripts(){
	...
	wp_register_script('carousel', ''.get_template_directory_uri().'/scripts/js/jquery.carouFredSel-6.1.0-packed.js', 'jquery');
	wp_enqueue_script('carousel');
	
	wp_register_script('mousewheel', ''.get_template_directory_uri().'/scripts/js/jquery.mousewheel.min.js', 'jquery');
	wp_enqueue_script('mousewheel');
	
	wp_register_script('touchSwipe', ''.get_template_directory_uri().'/scripts/js/jquery.touchSwipe.min.js', 'jquery');
	wp_enqueue_script('touchSwipe');
	
	wp_register_script('Bathrottle', ''.get_template_directory_uri().'/scripts/js/jquery.ba-throttle-debounce.min.js', 'jquery');
	wp_enqueue_script('Bathrottle');
